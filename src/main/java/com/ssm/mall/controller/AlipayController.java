...
import com.ssm.mall.util.AlipayConfig;
...
public class AlipayController {
    ...
    @RequestMapping("/pay")
    public String pay(@RequestBody MyOrder myOrder) throws Exception {

        //加入MyOder中
        myOrderService.add(myOrder);
        ...
        String out_trade_no = myOrder.getOrder_num();
        //付款金额，必填
        String total_amount = "" + myOrder.getTotal_price();
        //订单名称，必填
        String subject = myOrder.getOrder_name();
        //商品描述，可空
        String body = myOrder.getIntroduction();
    ...
    @RequestMapping("/pay2")
    public String pay2(int id) throws Exception {
    ...
    @RequestMapping("/pay3")
    public String pay3(String user_name) throws Exception {

        //从Redis中根据用户名找到当前要付款的订单
        MyOrder myOrder = (MyOrder) redisTemplate.boundHashOps("seckillMyOrder").get(user_name);
        System.out.println(myOrder);
    ...
    public String returnUrl(HttpServletRequest request) throws Exception {
        ...
        if(signVerified) {
            ...
            criteria.andOrder_numEqualTo(out_trade_no);
            ...
            System.out.println("用户：" + myOrder.getUser_name() + "支付成功");
